...
figname = f'{results_folder}Disp_relation_theory_h_nu2_{nu_2:.1e}_nu1_{nu_1:.1e}_zoomed_{zoomed_bool}'
plt.savefig(figname + '.pdf', bbox_inches='tight')
plt.savefig(figname + '.png', bbox_inches='tight')

#%% Plot attenuation - without experiments 
...
figname = f'{results_folder}Im_k_VS_f_theory_nu2_{nu_2:.1e}_nu1_{nu_1:.1e}_zoomed_{zoomed_bool}'
plt.savefig(figname + '.pdf', bbox_inches='tight')
plt.savefig(figname + '.png', bbox_inches='tight')
