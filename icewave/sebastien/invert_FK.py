...
csv_file = path2data + '/' + acqu_numb  + '/' + 'Physical_data_direction_1.csv'
...
frequency_list = np.linspace(1,100,100)
...
ax1.plot(frequency_list,k_flex_theory,linestyle = '--',color = 'w', label = 'Flexural mode')
ax1.plot(frequency_list,k_hydro_elast,linestyle = '--', color = 'r')
ax1.set_xlim([0 , 200])

#%%
figname = fig_folder + 'Unwrapped_flexural_with_theory_and_hydroelastic_wave'
