# -*- coding: utf-8 -*-
"""
Created on Fri Nov  7 15:27:19 2025

@author: sebas

This script generates a subplot of three space-time spectrum for different positions on the 
optical fiber.
...
fig_folder = f'{path2data}Figures_article/CWT/'
...
figname = f'{fig_folder}Flexural_modulus_fit_3pos_all_chunks_subpixel_swell_corrected_{label_UTC0}'
