# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 09:56:33 2026
...
imsh.set_clim([-5e4,5e4]) # [-1e4,1e4] for 0211
ax.set_xlabel(r'UTC')
...
#%% Show zoomed on source Z

chunk = 1
xmin = datetime(2025,2,12,19,27,31,500000)
xmax= datetime(2025,2,12,19,27,32,300000)
t0 = xmin.timestamp()
t1 = xmax.timestamp()
...
#%% Show zoomed on source N

chunk = 1
xmin = datetime(2025,2,12,19,28,12,800000)
xmax= datetime(2025,2,12,19,28,13,200000)
t0 = xmin.timestamp()
t1 = xmax.timestamp()
...
#%% Create a subplot from 0212 signal 
...
figname = f'{fig_folder}montage_spatio_temporal_{date}_{label_UTC0}_chunk_{chunk}'
plt.savefig(figname + '.pdf', bbox_inches='tight')
plt.savefig(figname + '.svg', bbox_inches='tight')
plt.savefig(figname + '.png', bbox_inches='tight')