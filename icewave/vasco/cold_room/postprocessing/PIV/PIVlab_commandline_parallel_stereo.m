...
function [u,v,s,p,xpix,ypix] = PIVlab_commandline_parallel_stereo(directory,reference,N,i0,Dt,b,W)
...
s{1,1}= 'Int. area 1';              s{1,2} = W*4;% W*4 %64;         % window size of first pass % changer su on fait plus que 3 passages
s{2,1}= 'Step size 1';              s{2,2} = W*2;%W*2 %32;         % step of first pass
...
s{7,1}= 'Int. area 2';              s{7,2}=W*2;%W*2 %32;        % second pass window size
s{8,1}= 'Int. area 3';              s{8,2}=W; %16;         % third pass window size
...
nr_of_cores = 10; % 10 pour babasse, 40 ou 20 pour adour 
