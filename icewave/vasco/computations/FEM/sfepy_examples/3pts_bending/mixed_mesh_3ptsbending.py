...
options = {
    ...
    'output_dir': 'C:/Users/Vasco Zanchi/Documents/git_local/sfepy_examples/3pts_bending/results',  # <--- folder where vtk files will be saved
}
...
regions = {
    ...
    'BottomLeft': ('vertex 0,1', 'vertex'),
    'Right': ('vertices in (x > 0.69)', 'facet'),
    'BottomRight': ('vertex 28,29', 'vertex'),
    ...
    'TopMiddleNodes': ('vertex 12,13', 'vertex')
...
equations = {
    ...
    """dw_lin_elastic.i.Omega(solid.D, v, u)
     + dw_lin_elastic.i.Omega_t(solid.D, v_t, u_t)
     = dw_point_load.0.TopMiddleNodes(vforce.val, v)
     """
}
