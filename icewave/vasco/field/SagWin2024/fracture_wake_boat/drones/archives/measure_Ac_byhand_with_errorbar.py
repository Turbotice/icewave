...
for i in range(len(matrix_temp_evol_uz)):
    dict_results_atfracpixels = clic2extract_amplitude_withref_singlepixel(temp_evol_uz=matrix_temp_evol_uz[i], t_frac_sec_approx=times_frac_sec_approx[i], dict_stereo_pivdata=dict_stereo_pivdata, arr_t_frac_sec=times_frac_sec_approx)
...
for i in range(len(matrix_temp_evol_uz_ref_noncassee)):
    dict_results_ref_noncassee= clic2extract_amplitude_withref_singlepixel(matrix_temp_evol_uz_ref_noncassee[i], times_frac_sec_approx_ref_noncassee[i], dict_stereo_pivdata)
