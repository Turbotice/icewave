...
longitude_S = array_Longitudes_gpx[indices_sources][18]
latitude_S = array_Latitudes_gpx[indices_sources][18] # indice 0 car il peut y avoir plusieurs sources auquelles on s'intéresse (donc tableau)
...
def find_9shocks(signal,typical_signal):# adjust height for find_peaks
    ...
    ppp = find_peaks(ycorr[pp[0]],width=2,distance=100,threshold=1e-2,height=100)
