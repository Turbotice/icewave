...
local_path=pwd;%'/Users/eddiaca/Desktop/PMMH/Banquise/Rimouski_2024/Redressement_Saguenay/Test_optimisation_focale/';
% chargement 
...
y_points_pix=POS_objets_bernache.POS(:,3); % direction verticale du capteur
...
x_pix=repmat([1:size(image_mesange,2)],size(image_mesange,1),1);
y_pix=repmat([1:size(image_mesange,1)]',1,size(image_mesange,2));
...
y_points_pix=POS_objets_mesange.POS(:,3); % direction verticale du capteur
