function [Vx_s,Vy_s] = get_scaled_velocity_field(Vx,Vy,fx,scale_V,i,caxis_amp,fig_folder)
...
Vxmoy = nanmean(Vx_s,3);
Vymoy = nanmean(Vy_s,3);
Vxstd = std(Vx_s,[],3);
Vystd = std(Vy_s,[],3);
