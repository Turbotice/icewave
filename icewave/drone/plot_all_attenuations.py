...
ax.plot(x2fit,y2fit,'.',color = 'tab:blue',ms = ms,alpha = 0.5,label = 'field')
...
ax.plot(f,alpha,'.',color = 'tab:orange',ms = ms,alpha = 0.5,label = 'laboratory')
...
figname = f'{fig_folder}comparison_attenuation_lab_field'
plt.savefig(figname + '.pdf', bbox_inches='tight')
plt.savefig(figname + '.png', bbox_inches='tight')
