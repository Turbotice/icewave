...
from PhyphoxWindow import PhyphoxWindow
from TemperatureWindow import TemperatureWindow
...
#        tabs.addTab(widget_network,'Network')
        ...
        self.PhyphoxWindow=PhyphoxWindow(self)
        self.tabs.addTab(self.PhyphoxWindow,'Phyphox')
        self.setCentralWidget(self.tabs)
        
    def get_tabs(self):
        tablist = { 'Network':  {'adb connect':self.act_adb_connect,\
                                'Display':self.act_test_connect,\
                    ...
                    'Pictures':{'Take picture':self.act_take_picture}, \
